                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs alert_notif' title='Delete Data' href='?view=jurusan&hapus=$r[kode_jurusan]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
...
<?php 
    ...
    if (isset($_POST[update])){
        mysqli_query($koneksi,"UPDATE jurusan SET kode_jurusan = '$_POST[a]',
                                         ...
                                         jabatan = '$_POST[g]',
                                         keterangan = '$_POST[h]',
                                         aktif = '$_POST[i]' where kode_jurusan='$_POST[id]'");
      echo "<script>document.location='index.php?view=jurusan';</script>";
    }
    $edit = mysqli_query($koneksi,"SELECT * FROM jurusan where kode_jurusan='$_GET[id]'");
    $s = mysqli_fetch_array($edit);
    echo "<div class='col-md-12'>
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Pejabat</th>            <td><input type='text' class='form-control' name='f' value='$s[pejabat]'></td></tr>
                    <tr><th scope='row'>Jabatan</th>           <td><input type='text' class='form-control' name='g' value='$s[jabatan]'></td></tr>
                    <tr><th scope='row'>Keterangan</th>           <td><input type='text' class='form-control' name='h' value='$s[keterangan]'></td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=jurusan'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
    ...
    if (isset($_POST[tambah])){
        mysqli_query($koneksi,"INSERT INTO jurusan VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]','$_POST[i]')");
        echo "<script>document.location='index.php?view=jurusan';</script>";
    }
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Pejabat</th>            <td><input type='text' class='form-control' name='f'></td></tr>
                    <tr><th scope='row'>Jabatan</th>           <td><input type='text' class='form-control' name='g'></td></tr>
                    <tr><th scope='row'>Keterangan</th>           <td><input type='text' class='form-control' name='h'></td></tr>
                    <tr><th scope='row'>Aktif</th>                <td><input type='radio' name='i' value='Ya'> Ya
                                                                      <input type='radio' name='i' value='Tidak'> Tidak </td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
