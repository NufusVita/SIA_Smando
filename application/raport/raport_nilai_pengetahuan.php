        ...
        <div class='box-body'>
          ...
          <div class='panel-body'>
              <table class='table table-bordered table-striped'>
                                ...
                                <tr>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>PH1</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>PH2</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>PH3</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>PTS</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>PAS</center></th>
                                </tr>
                              <tbody>";
                              $no = 1;
