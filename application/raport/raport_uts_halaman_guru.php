                ...
                <div class="box-body">
                  ...
                  <?php
                                            ...
                                            JOIN mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN guru c ON a.nip=c.nik 
                                                JOIN ruangan d ON a.kode_ruangan=d.kode_ruangan
                                                  ...
                                                  where c.nip='$_SESSION[id]' AND c.nip='$iden[nip]'
                    ...
                    while($r=mysqli_fetch_array($tampil)){
                      $n = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM jadwal_pelajaran where kodejdwl='$r[kodejdwl]' AND nip='$iden[nik]'"));
                    echo "<tr><td>$no</td>
