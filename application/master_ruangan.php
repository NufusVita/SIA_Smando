                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs alert_notif' title='Delete Data' href='?view=ruangan&hapus=$r[kode_ruangan]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=ruangan'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
