...
<?php
  ...
  $no = 1;
  $tampil = mysqli_query($koneksi, "SELECT * FROM forum_topic where kodejdwl='$_GET[jdwl]' ORDER BY id_forum_topic ASC");
  while ($r = mysqli_fetch_array($tampil)) {
    ...
    if ($_SESSION[level] == 'siswa' or $_SESSION[level] == 'kepala') {
      ...
      echo "<td style='width:140px'><a class='btn btn-success btn-xs' title='Lihat Detail' href='index.php?view=forum&act=detailtopic&jdwl=$_GET[jdwl]&idtopic=$r[id_forum_topic]&id=$_GET[id]&kd=$_GET[kd]'><span class='glyphicon glyphicon-th-list'></span> Lihat Balasan</a>
                                  <a class='btn btn-danger btn-xs alert_notif' title='Delete Topic' href='index.php?view=forum&act=list&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&hapus=$r[id_forum_topic]'><span class='glyphicon glyphicon-remove'></span></a>
                              </td>";
    }
  ...
  echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=forum'><button class='btn btn-default pull-right'>Batal</button></a>
  ...
  $topic = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM forum_topic a 
              JOIN jadwal_pelajaran b ON a.kodejdwl=b.kodejdwl
                JOIN guru c ON b.nip=c.nik where a.id_forum_topic='$_GET[idtopic]'"));
  ...
  echo "<div class='col-md-12'>
              <div class='box box-success'>
                <div class='box-header'>
                  ...
                  <a href='index.php?view=forum&act=detailtopic&jdwl=$_GET[jdwl]&idtopic=$_GET[idtopic]&id=$_GET[id]&kd=$_GET[kd]&deletetopic' class='alert_notif'><i class='fa fa-remove pull-right'></i></a>
                </div>
  ...
  while ($k = mysqli_fetch_array($komentar)) {
    if ($k[nama] == '') {
      ...
      echo "<p class='message'><small class='text-muted'>
                                <a href='index.php?view=forum&act=detailtopic&jdwl=$_GET[jdwl]&idtopic=$_GET[idtopic]&id=$_GET[id]&kd=$_GET[kd]&deletekomentar=$k[id_forum_komentar]' class='alert_notif'><i class='fa fa-remove pull-right'></i></a> <i class='fa fa-clock-o'></i> $k[waktu_komentar] WIB </small>
