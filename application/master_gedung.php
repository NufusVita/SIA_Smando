              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query($koneksi,"SELECT * FROM gedung ORDER BY kode_gedung ASC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs alert_notif' title='Delete Data' href='index.php?view=gedung&hapus=$r[kode_gedung]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                              echo "</tr>";
                      $no++;
...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=gedung'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
