  ...
  while ($r = mysqli_fetch_array($tampil)) {
    ...
    if ($_SESSION[level] == 'superuser') {
      ...
      echo "<a class='btn btn-success btn-xs' title='Edit Bahan dan Tugas' href='index.php?view=bahantugas&act=edit&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&edit=$r[id_elearning]'><span class='glyphicon glyphicon-edit'></span></a>
                                        <a class='btn btn-danger btn-xs alert_notif' title='Delete Bahan dan Tugas' href='index.php?view=bahantugas&act=listbahantugas&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&hapus=$r[id_elearning]'><span class='glyphicon glyphicon-trash'></span></a>
                              </td>
                            </tr>";
    } elseif ($_SESSION[level] == 'siswa') {
      ...
      if ($r[id_kategori_elearning] == '1') {
        ...
        echo "<td><a style='width:167px' class='btn btn-danger btn-xs alert_notif' title='Waktu Habis' href=''><span class='glyphicon glyphicon-remove'></span> Waktu Habis</a></td></tr>";
      }
      ...
      if ($r[id_kategori_elearning] == '1') {
        ...
        echo "<td><a class='btn btn-info btn-xs' title='Download Bahan dan Tugas' href='download.php?file=$r[file_upload]'><span class='glyphicon glyphicon-download'></span> Download</a>
                                            <a class='btn btn-success btn-xs' title='Kirim Bahan dan Tugas' href='index.php?view=bahantugas&act=jawabanguru&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&ide=$r[id_elearning]'><span class='glyphicon glyphicon-upload'></span> Jawaban Tugas</a>";
      }
      echo "<a style='margin-left:3px' class='btn btn-warning btn-xs' title='Edit $r[nama_kategori_elearning]' href='index.php?view=bahantugas&act=edit&jdwl=" . $_GET[jdwl] . "&id=" . $_GET[id] . "&kd=" . $_GET[kd] . "&edit=$r[id_elearning]'><span class='glyphicon glyphicon-edit'></span></a>
                                        <a class='btn btn-danger btn-xs alert_notif' title='Delete $r[nama_kategori_elearning]' href='index.php?view=bahantugas&act=listbahantugas&jdwl=" . $_GET[jdwl] . "&id=" . $_GET[id] . "&kd=" . $_GET[kd] . "&hapus=$r[id_elearning]'><span class='glyphicon glyphicon-remove'></span></a></td></tr>";
    }
    $no++;
  }
...
<?php echo "</a> <span style='width:155px' class='label label-info' id='upload-file-info'></span>
                    ...
                    <tr><th scope='row'>Waktu Mulai</th>      <td><input type='datetime' class='form-control' value='" . date("Y-m-d H:i:s") . "' name='d'></td></tr>
                    <tr><th scope='row'>Waktu Selesai</th>    <td><input type='datetime' class='form-control' value='" . date("Y-m-d H:i:s") . "' name='e'></td></tr>
...
<?php echo "</a> <span style='width:155px' class='label label-info' id='upload-file-info'></span>
                    ...
                    <tr><th scope='row'>Waktu Mulai</th>      <td><input type='datetime' class='form-control' value='$s[tanggal_tugas]' name='d'></td></tr>
                    <tr><th scope='row'>Waktu Selesai</th>    <td><input type='datetime' class='form-control' value='$s[tanggal_selesai]' name='e'></td></tr>
              ...
              $tampil = mysqli_query($koneksi, "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, b.kode_kurikulum, c.nama_guru, d.nama_ruangan FROM jadwal_pelajaran a 
                                            JOIN mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN guru c ON a.nip=c.nik 
                                                JOIN ruangan d ON a.kode_ruangan=d.kode_ruangan
                                                JOIN kelas e ON a.kode_kelas=e.kode_kelas 
                                                  where b.kode_kurikulum='$kurikulum[kode_kurikulum]' AND a.nip='$guru[nik]' AND a.id_tahun_akademik LIKE '%" . date('Y') . "%' ORDER BY a.hari ASC");
            }
            $no = 1;
            while ($r = mysqli_fetch_array($tampil)) {
              $total = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM elearning where kodejdwl='$r[kodejdwl]'"));
...
<?php echo "</a> <span style='width:155px' class='label label-info' id='upload-file-info'></span>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=bahantugas'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
                  </div>
              </form>
            </div>";
  }
  ...
  echo "<div class='col-md-12'>
              ...
              <input type='hidden' name='kelas' value='$_GET[id]'>
              <input type='hidden' name='pelajaran' value='$_GET[kd]'>
              <input type='hidden' name='act' value='jawaban'>
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                      <thead>
                      <tr>
  ...
  $no = 1;
  $tampil = mysqli_query($koneksi, "SELECT * FROM elearning_jawab a JOIN siswa b ON a.nisn=b.nisn where a.id_elearning='$_GET[id]' ORDER BY a.id_elearning_jawab DESC");
  //$guru = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM guru where nip = '$_SESSION[id]'"));
  while ($r = mysqli_fetch_array($tampil)) {
    echo "<tr>
                              <td>$no</td>
  ...
  echo "<div class='col-md-12'>
              ...
              <input type='hidden' name='kelas' value='$_GET[id]'>
              <input type='hidden' name='pelajaran' value='$_GET[kd]'>
              <input type='hidden' name='tugas' value='$_GET[ide]'>
              <input type='hidden' name='act' value='jawabanguru'>
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                      <thead>
                      <tr>
