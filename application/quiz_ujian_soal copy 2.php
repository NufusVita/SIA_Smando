...
<?php
  ...
  while ($k = mysqli_fetch_array($essai)) {
    echo "<tr>
                            ...
                            <td style='width:80px'><center><a  class='btn btn-success btn-xs' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]&editessai=$k[id_pertanyaan_essai]'><span class='glyphicon glyphicon-edit'></span></a>
                            <a  class='btn btn-danger btn-xs alert_notif' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]&deleteessai=$k[id_pertanyaan_essai]'><span class='glyphicon glyphicon-remove'></span></a></center></td>
                            </tr>";
    $no++;
  }
  echo "</table>
  ...
  while ($ko = mysqli_fetch_array($objektif)) {
    ...
    echo "<div class='btn btn-default btn-xs btn-block'>Kunci Jawaban : $ko[kunci_jawaban]</div>
                            ...
                            <td style='width:60px'><a class='btn btn-danger btn-xs alert_notif' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]&deleteobjektif=$ko[id_pertanyaan_objektif]'><span class='glyphicon glyphicon-remove'></span></a></td>
                            </tr>";
    $noo++;
  }
  echo "</table>
