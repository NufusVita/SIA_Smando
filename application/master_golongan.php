              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query($koneksi,"SELECT * FROM golongan ORDER BY id_golongan ASC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs alert_notif' title='Delete Data' href='index.php?view=golongan&hapus=$r[id_golongan]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
...
<?php 
    ...
    if (isset($_POST[update])){
        mysqli_query($koneksi,"UPDATE golongan SET nama_golongan = '$_POST[a]',
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=golongan'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
