                  ...
                  <?php 
                    ...
                    echo "<tr><td width=40px>$no</td>
                              ...
                              <td width='90px'><center>
                                <a target='_BLANK' class='btn btn-primary btn-xs' href='print-raport_uts.php?siswa=$r[nisn]&id=$r[kode_kelas]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-print'></span> Print Raport UTS</a>
                              </center></td>";
                            echo "</tr>";
                      $no++;
                      }
