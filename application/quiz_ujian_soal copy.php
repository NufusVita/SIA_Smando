...
<?php
  ...
  while ($k = mysqli_fetch_array($essai)) {
    echo "<tr>
                            ...
                            <td style='width:60px'><a  class='btn btn-danger btn-xs alert_notif' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]&deleteessai=$k[id_pertanyaan_essai]'><span class='glyphicon glyphicon-remove'></span></a></td>
                            <td style='width:60px'><a class='btn btn-success btn-xs' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]&deleteessai=$k[id_pertanyaan_essai]'><span class='glyphicon glyphicon-edit'></span></a></td>
                            </tr>";
    $no++;
  }
  echo "</table>
