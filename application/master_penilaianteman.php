                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs alert_notif' title='Delete Data' href='index.php?view=penilaianteman&hapus=$r[id_pertanyaan_penilaian]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=penilaianteman'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
