                                                ...
                                                JOIN ruangan d ON a.kode_ruangan=d.kode_ruangan
                                                  ...
                                                  where a.kode_kelas='$_GET[kelas]' AND 
                                                    a.id_tahun_akademik='$_GET[tahun]' AND 
                                                      b.kode_kurikulum='$kurikulum[kode_kurikulum]' ORDER BY a.hari ASC");
            }
            $no = 1;
            while ($r = mysqli_fetch_array($tampil)) {
              ...
              if ($_SESSION[level] != 'kepala') {
                echo "<td style='width:70px !important'><center>
                                        ...
                                        <a class='btn btn-danger btn-xs alert_notif' title='Hapus Jadwal' href='index.php?view=jadwalpelajaran&hapus=$r[kodejdwl]'><span class='glyphicon glyphicon-remove'></span></a>
                                      </center></td>";
              }
              echo "</tr>";
              $no++;
...
<?php
  ...
  if (isset($_POST[tambah])) {
    mysqli_query($koneksi, "INSERT INTO jadwal_pelajaran VALUES('','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]','$_POST[i]')");
    echo "<script>document.location='index.php?view=jadwalpelajaran';</script>";
  }
  ...
  echo "</select>
                    ...
                    <tr><th scope='row'>Jam Mulai</th>  <td><input type='time' class='form-control' name='f' placeholder='hh:ii' value='" . date('H:i') . "'></td></tr>
                    <tr><th scope='row'>Jam Selesai</th><td><input type='time' class='form-control' name='g' placeholder='hh:ii' value='" . date('H:i') . "'></td></tr>
                    <tr><th scope='row'>Hari</th>  <td><select class='form-control' name='h'>
                    ...
                    <tr><th scope='row'>Aktif</th>                <td><input type='radio' name='i' value='Ya' checked> Ya
                                                                             <input type='radio' name='i' value='Tidak'> Tidak
                    </td></tr>
                  </tbody>
                  </table>
                </div>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=jadwalpelajaran'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
  ...
  if (isset($_POST[update])) {
    mysqli_query($koneksi, "UPDATE jadwal_pelajaran SET id_tahun_akademik = '$_POST[a]',
                                                    ...
                                                    jam_selesai = '$_POST[g]',
                                                    hari = '$_POST[h]',
                                                    aktif = '$_POST[i]' where kodejdwl='$_POST[id]'");
    echo "<script>document.location='index.php?view=jadwalpelajaran';</script>";
  }
  ...
  echo "</select>
                    ...
                    <tr><th scope='row'>Jam Mulai</th>  <td><input type='time' class='form-control' name='f' placeholder='hh:ii' value='$e[jam_mulai]'></td></tr>
                    <tr><th scope='row'>Jam Selesai</th><td><input type='time' class='form-control' name='g' placeholder='hh:ii' value='$e[jam_selesai]'></td></tr>
                    <tr><th scope='row'>Hari</th>  <td><select class='form-control' name='h'>
  ...
  if ($e[aktif] == 'Ya') {
    echo "<input type='radio' name='i' value='Ya' checked> Ya
                                                                             <input type='radio' name='i' value='Tidak'> Tidak";
  } else {
    echo "<input type='radio' name='i' value='Ya'> Ya
                                                                             <input type='radio' name='i' value='Tidak' checked> Tidak";
  }
  echo "</td></tr>
                  </tbody>
                  </table>
