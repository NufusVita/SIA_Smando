    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><?php if (isset($_GET[tahun])) {
                                echo "Data Kompetensi Dasar";
                              } else {
                                echo "Data Kompetensi Dasar pada " . date('Y');
                              } ?></h3>
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            if (isset($_GET[tahun])) {
              $tampil = mysqli_query($koneksi, "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, d.nama_ruangan FROM jadwal_pelajaran a 
...
<?php
  ...
  $d = mysqli_fetch_array(mysqli_query($koneksi, "SELECT a.kode_kelas, b.nama_kelas, c.namamatapelajaran FROM `jadwal_pelajaran` a JOIN kelas b ON a.kode_kelas=b.kode_kelas JOIN mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran where a.kodejdwl='$_GET[id]'"));
